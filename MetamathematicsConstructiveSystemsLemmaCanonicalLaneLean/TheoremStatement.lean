import MetamathematicsConstructiveSystemsLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  constrainedStatement := "constrained theorem certificate internalized through source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
